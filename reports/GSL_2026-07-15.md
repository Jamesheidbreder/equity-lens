...
We rate GSL **BUY** with a price target of **$53.48**, against a current price of $40.79 (+31.1% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: discounted cash flow values the shares at $83.41; peer comparables values the shares at $48.27; own historical multiple values the shares at $18.79.
...
### Peer comparables — $48.27 per share

| Assumption | Value |
|---|---|
| Trailing | eps 10.46; peer median pe 4.94 |
