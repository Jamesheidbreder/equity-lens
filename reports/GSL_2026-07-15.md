...
| Price | $40.71 |
| Target price | **$53.44** (base model $53.44) |
| Implied upside | +31.3% |
...
We rate GSL **BUY** with a price target of **$53.44**, against a current price of $40.71 (+31.3% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: discounted cash flow values the shares at $83.40; peer comparables values the shares at $48.13; own historical multiple values the shares at $18.79.
...
### Discounted cash flow — $83.40 per share
...
### Peer comparables — $48.13 per share

| Assumption | Value |
|---|---|
| Trailing | eps 10.46; peer median pe 4.92 |
| Forward | eps 8.99; peer median pe 4.99 |
...
- Less net debt $0.3B → equity value $3.0B → **$83.40 per share**
