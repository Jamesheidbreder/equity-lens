...
| Price | $326.06 |
| Target price | **$225.98** (base model $196.51) |
| Implied upside | -30.7% |
...
We rate AAPL **SELL** with a price target of **$225.98**, against a current price of $326.06 (-30.7% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.51; peer comparables values the shares at $187.23; own historical multiple values the shares at $267.11.
...
### Discounted cash flow — $150.51 per share
...
### Peer comparables — $187.23 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.68 |
| Forward | eps 9.62; peer median pe 18.62 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,498.5B), discounted to $1,742.7B (77% of total value)
- Less net debt $42.4B → equity value $2,210.6B → **$150.51 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,789.1B | 39.5 | 33.9 | — | 44.9 | — | — |
| Microsoft Corporation | $2,951.2B | 23.7 | 20.5 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,522.3B | 28.2 | 25.4 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $258.6B | 31.9 | 18.6 | 22.5 | -185.0 | 6.3% | — |
| HP Inc. | $21.3B | 8.7 | 7.7 | 6.3 | -148.5 | 4.4% | — |
| Sony Group Corporation | $121.9B | 19.6 | 17.4 | 0.0 | 2.4 | -2.6% | 12.3% |
