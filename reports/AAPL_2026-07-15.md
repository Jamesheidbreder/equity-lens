...
| Price | $325.94 |
| Target price | **$226.19** (base model $196.68) |
| Implied upside | -30.6% |
...
We rate AAPL **SELL** with a price target of **$226.19**, against a current price of $325.94 (-30.6% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.65; peer comparables values the shares at $187.62; own historical multiple values the shares at $267.11.
...
### Discounted cash flow — $150.65 per share
...
### Peer comparables — $187.62 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.67 |
| Forward | eps 9.62; peer median pe 18.71 |
...
| 14.0% | 201 | 198 | 195 | 193 | 191 |
| 15.0% | 202 | 199 | 197 | 194 | 192 |
| 16.0% | 204 | 201 | 198 | 196 | 193 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,505.3B), discounted to $1,744.9B (77% of total value)
- Less net debt $42.4B → equity value $2,212.7B → **$150.65 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,787.2B | 39.5 | 33.9 | — | 44.9 | — | — |
| Microsoft Corporation | $2,949.9B | 23.7 | 20.5 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,534.0B | 28.3 | 25.5 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $259.9B | 32.1 | 18.7 | 22.5 | -185.9 | 6.3% | — |
| HP Inc. | $21.4B | 8.7 | 7.8 | 6.3 | -148.9 | 4.4% | — |
...
- **The call:** SELL with a $226.19 target against a $325.94 price (-30.6% implied); street consensus $316.76.
- **The evidence:** our independent lenses value the shares at $150.65 / $187.62 / $267.11; the blended base case is $196.68, adjusted to $226.19 by the disclosed analyst overlay.
- **Conviction:** moderate — the widest and narrowest lenses differ by 1.8x; per our methodology, tighter agreement means higher confidence in the target.
