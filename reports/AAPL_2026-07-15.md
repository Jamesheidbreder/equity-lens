...
| Price | $325.18 |
| Target price | **$226.22** (base model $196.71) |
| Implied upside | -30.4% |
| Street consensus target | $316.76 (42 analysts) |
| Market cap | $4,776.1B |
| 52-week range | $201.50 – $325.68 |
| Beta | 1.097 |
| Dividend yield | 0.34% |
...
We rate AAPL **SELL** with a price target of **$226.22**, against a current price of $325.18 (-30.4% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.63; peer comparables values the shares at $187.74; own historical multiple values the shares at $267.11.
...
### Discounted cash flow — $150.63 per share
...
### Peer comparables — $187.74 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.71 |
| Forward | eps 9.62; peer median pe 18.70 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,504.2B), discounted to $1,744.5B (77% of total value)
- Less net debt $42.4B → equity value $2,212.4B → **$150.63 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,776.1B | 39.4 | 33.8 | — | 44.8 | — | — |
| Microsoft Corporation | $2,955.6B | 23.7 | 20.6 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,526.2B | 28.3 | 25.4 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $259.7B | 32.0 | 18.7 | 22.5 | -185.8 | 6.3% | — |
