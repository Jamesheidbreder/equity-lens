...
| Price | $326.87 |
| Target price | **$226.00** (base model $196.52) |
| Implied upside | -30.9% |
...
We rate AAPL **SELL** with a price target of **$226.00**, against a current price of $326.87 (-30.9% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.50; peer comparables values the shares at $187.29; own historical multiple values the shares at $267.11.
...
### Discounted cash flow — $150.50 per share
...
### Peer comparables — $187.29 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.70 |
| Forward | eps 9.62; peer median pe 18.61 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,497.9B), discounted to $1,742.5B (77% of total value)
- Less net debt $42.4B → equity value $2,210.4B → **$150.50 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,800.9B | 39.6 | 34.0 | — | 45.0 | — | — |
| Microsoft Corporation | $2,954.1B | 23.7 | 20.5 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,539.5B | 28.4 | 25.5 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $258.5B | 31.9 | 18.6 | 22.5 | -185.0 | 6.3% | — |
