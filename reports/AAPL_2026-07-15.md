...
| Price | $326.78 |
| Target price | **$225.98** (base model $196.50) |
| Implied upside | -30.8% |
...
We rate AAPL **SELL** with a price target of **$225.98**, against a current price of $326.78 (-30.8% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.48; peer comparables values the shares at $187.26; own historical multiple values the shares at $267.11.
...
Our target sits -28.7% vs. street consensus of $316.76. The divergence is our documented view, not an input: consensus never enters the models.
...
### Discounted cash flow — $150.48 per share
...
### Peer comparables — $187.26 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.70 |
| Forward | eps 9.62; peer median pe 18.60 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,497.0B), discounted to $1,742.3B (77% of total value)
- Less net debt $42.4B → equity value $2,210.1B → **$150.48 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,799.5B | 39.6 | 34.0 | — | 45.0 | — | — |
| Microsoft Corporation | $2,954.7B | 23.7 | 20.5 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,541.2B | 28.4 | 25.5 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $258.4B | 31.9 | 18.6 | 22.5 | -184.9 | 6.3% | — |
| HP Inc. | $21.3B | 8.7 | 7.7 | 6.3 | -148.6 | 4.4% | — |
...
- **The call:** SELL. Our target is $225.98 against a current price of $326.78, an implied return of -30.8%. Street consensus stands at $316.76.
- **The evidence:** our independent lenses value the shares at $150.48, $187.26, and $267.11. The blended base case is $196.50. A disclosed analyst overlay adjusts this to $225.98.
