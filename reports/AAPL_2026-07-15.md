...
| Price | $326.09 |
| Target price | **$226.33** (base model $196.81) |
| Implied upside | -30.6% |
| Street consensus target | $316.76 (42 analysts) |
| Market cap | $4,789.5B |
| 52-week range | $201.50 – $326.37 |
| Beta | 1.097 |
| Dividend yield | 0.34% |
...
We rate AAPL **SELL** with a price target of **$226.33**, against a current price of $326.09 (-30.6% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $150.77; peer comparables values the shares at $187.90; own historical multiple values the shares at $267.11.
...
Our target sits -28.5% vs. street consensus of $316.76. The divergence is our documented view, not an input: consensus never enters the models.
...
### Discounted cash flow — $150.77 per share
...
### Peer comparables — $187.90 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.25; peer median pe 23.64 |
| Forward | eps 9.62; peer median pe 18.79 |
...
- Terminal value: average of Gordon growth ($2,089.5B) and exit multiple ($3,511.2B), discounted to $1,746.7B (77% of total value)
- Less net debt $42.4B → equity value $2,214.5B → **$150.77 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,789.5B | 39.5 | 33.9 | — | 44.9 | — | — |
| Microsoft Corporation | $2,946.8B | 23.6 | 20.5 | 15.8 | 7.1 | 39.3% | 34.0% |
| Alphabet Inc. | $4,536.4B | 28.3 | 25.5 | 26.8 | 9.4 | 37.9% | 38.9% |
| Dell Technologies Inc. | $261.0B | 32.2 | 18.8 | 22.5 | -186.7 | 6.3% | — |
| HP Inc. | $21.4B | 8.8 | 7.8 | 6.3 | -149.4 | 4.4% | — |
| Sony Group Corporation | $122.1B | 19.6 | 17.5 | 0.0 | 2.4 | -2.6% | 12.3% |
