...
| Price | $57.05 |
| Target price | **$43.70** (base model $43.70) |
| Implied upside | -23.4% |
...
We rate FITB **SELL** with a price target of **$43.70**, against a current price of $57.05 (-23.4% implied return). Within our coverage universe, the name ranks **Underweight**.

The target blends independent valuation lenses: justified price-to-book values the shares at $36.39; peer comparables values the shares at $47.06; own historical multiple values the shares at $47.65.
...
Cost of equity: **9.04%** (10Y Treasury 4.62% risk-free base, CAPM).
