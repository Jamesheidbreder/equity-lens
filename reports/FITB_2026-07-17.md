...
**Equity Research | Financials — Regional Banks | 2026-07-17**
...
| Price | $58.13 |
| Target price | **$44.20** (base model $44.20) |
| Implied upside | -24.0% |
...
We rate FITB **SELL** with a price target of **$44.20**, against a current price of $58.13 (-24.0% implied return). Within our coverage universe, the name ranks **Underweight**.

The target blends independent valuation lenses: justified price-to-book values the shares at $36.82; peer comparables values the shares at $48.12; own historical multiple values the shares at $47.65.

Our target sits -27.3% vs. street consensus of $60.80. The divergence is our documented view, not an input: consensus never enters the models.
...
Cost of equity: **8.97%** (10Y Treasury 4.55% risk-free base, CAPM).
...
- **curve_slope_roe** [T10Y2Y] — 10y-2y slope 0.41%, +0.00pp vs 10y median. Adjustment: +0.00% to roe. Banks earn the spread between long lending and short funding; a steeper-than-normal curve supports richer margins and ROE, a flat/inverted curve compresses them.
...
### Justified price-to-book — $36.82 per share

| Assumption | Value |
|---|---|
| Book per share | 23.97 |
| Normalized roe | 12.45% |
| Cost of equity | 8.97% |
| Growth | 2.50% |
| Fair pb multiple | 1.54 |

### Peer comparables — $48.12 per share

| Assumption | Value |
|---|---|
| Trailing | eps 2.97; peer median pe 14.12 |
| Forward | eps 4.92; peer median pe 11.03 |
...
|---|---|---|---|---|---|---|---|
| **FITB (subject)** | $52.7B | 19.6 | 11.8 | — | 1.6 | — | — |
| Huntington Bancshares Incorpora | $37.2B | 14.1 | 9.6 | — | 1.3 | 26.6% | 8.4% |
| Regions Financial Corporation | $27.2B | 13.2 | 11.2 | — | 1.6 | 31.0% | 11.9% |
| KeyCorp | $25.6B | 14.5 | 11.0 | — | 1.5 | 27.0% | 10.0% |
| Citizens Financial Group, Inc. | $30.7B | 15.8 | 11.2 | — | 1.3 | 25.0% | 7.7% |
...
- Institutional ownership: 92% — professional holders with governance voting power.
...
- **The call:** SELL. Our target is $44.20 against a current price of $58.13, an implied return of -24.0%. Street consensus stands at $60.80.
- **The evidence:** our independent lenses value the shares at $36.82, $48.12, and $47.65. The blended base case is $44.20.
- **Conviction:** high. The widest and narrowest lenses differ by 1.3x. Tighter agreement between independent methods means higher confidence in the target.
- **Within coverage:** ranked Underweight, #6 among the names we cover.
