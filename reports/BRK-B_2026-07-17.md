...
**Equity Research | Financials — Diversified Holdings / Insurance | 2026-07-17**
...
| Price | $493.32 |
| Target price | **$604.09** (base model $604.09) |
| Implied upside | +22.5% |
...
We rate BRK-B **BUY** with a price target of **$604.09**, against a current price of $493.32 (+22.5% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: justified price-to-book values the shares at $595.20; peer price-to-book values the shares at $612.98.

Our target sits +16.1% vs. street consensus of $520.33. The divergence is our documented view, not an input: consensus never enters the models.
...
Cost of equity: **7.40%** (10Y Treasury 4.55% risk-free base, CAPM).
...
- **cash_yield_roe** [DTB3] — 3-month T-bill 3.70%, +1.69pp vs 10y median; cash is 4% of book. Adjustment: +0.07% to roe. A large cash-and-bills pile earns the short rate; rates above their norm mechanically lift returns on it.
...
### Justified price-to-book — $595.20 per share
...
### Peer price-to-book — $612.98 per share
...
|---|---|---|---|---|---|
| 9.3% | 595 | 562 | 536 | 515 | 497 |
| 10.3% | 638 | 600 | 570 | 546 | 525 |
| 11.3% | 680 | 638 | 604 | 577 | 554 |
| 12.3% | 723 | 676 | 638 | 607 | 582 |
| 13.3% | 766 | 714 | 672 | 638 | 610 |

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **BRK-B (subject)** | $1,064.0B | 14.7 | 22.9 | — | 0.0 | — | — |
| Progressive Corporation (The) | $120.6B | 10.4 | 12.8 | 8.2 | 4.0 | 12.8% | 34.9% |
| Chubb Limited | $135.8B | 12.4 | 12.0 | 10.8 | 1.8 | 18.5% | 15.4% |
| Allstate Corporation (The) | $63.9B | 5.5 | 9.4 | 4.5 | 2.2 | 17.8% | 45.2% |
| Markel Group Inc. | $24.6B | 14.2 | 16.8 | 8.0 | 1.4 | 11.1% | 10.0% |
| Loews Corporation | $23.6B | 14.6 | 39.6 | 8.4 | 1.3 | 8.8% | 9.2% |
...
- **The call:** BUY. Our target is $604.09 against a current price of $493.32, an implied return of +22.5%. Street consensus stands at $520.33.
- **The evidence:** our independent lenses value the shares at $595.20, and $612.98. The blended base case is $604.09.
- **Conviction:** high. The widest and narrowest lenses differ by 1.0x. Tighter agreement between independent methods means higher confidence in the target.
- **Within coverage:** ranked Overweight, #3 among the names we cover.
