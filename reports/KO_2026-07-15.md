...
We rate KO **SELL** with a price target of **$69.38**, against a current price of $82.97 (-16.4% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $66.16; peer comparables values the shares at $65.95; own historical multiple values the shares at $77.08.
...
| Forward | eps 3.48; peer median pe 17.37 |
...
|---|---|---|---|---|---|---|---|
| **KO (subject)** | $357.0B | 26.1 | 23.8 | — | 10.6 | — | — |
| Pepsico, Inc. | $186.5B | 17.9 | 15.2 | 12.1 | 8.7 | 10.8% | 51.5% |
