...
| Price | $83.00 |
| Target price | **$69.40** (base model $69.40) |
| Implied upside | -16.4% |
...
We rate KO **SELL** with a price target of **$69.40**, against a current price of $83.00 (-16.4% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $66.16; peer comparables values the shares at $66.05; own historical multiple values the shares at $77.08.
...
### Peer comparables — $66.05 per share

| Assumption | Value |
|---|---|
| Trailing | eps 3.18; peer median pe 22.53 |
| Forward | eps 3.48; peer median pe 17.36 |
...
- Terminal value: average of Gordon growth ($404.5B) and exit multiple ($285.3B), discounted to $255.8B (83% of total value)
- Less net debt $25.3B → equity value $284.7B → **$66.16 per share**
...
| Pepsico, Inc. | $185.8B | 17.8 | 15.1 | 12.1 | 8.7 | 10.8% | 51.5% |
| Keurig Dr Pepper Inc. | $41.4B | 22.5 | 12.0 | 17.4 | 1.6 | 10.8% | 6.3% |
...
| Procter & Gamble Company (The) | $344.3B | 21.6 | 20.9 | 14.6 | 6.4 | 19.2% | 31.1% |
