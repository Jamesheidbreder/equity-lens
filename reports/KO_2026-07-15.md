...
**Equity Research | Consumer Staples — Beverages | 2026-07-15**
...
| Price | $83.00 |
| Target price | **$69.44** (base model $69.44) |
| Implied upside | -16.3% |
...
We rate KO **SELL** with a price target of **$69.44**, against a current price of $83.00 (-16.3% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $66.17; peer comparables values the shares at $66.15; own historical multiple values the shares at $77.08.

Our target sits -20.0% vs. street consensus of $86.85. The divergence is our documented view, not an input: consensus never enters the models.
...
### Discounted cash flow — $66.17 per share
...
### Peer comparables — $66.15 per share

| Assumption | Value |
|---|---|
| Trailing | eps 3.18; peer median pe 22.58 |
| Forward | eps 3.48; peer median pe 17.38 |
| Peers used | PEP, KDP, MNST, MDLZ, PG |

### Own historical multiple — $77.08 per share
...
- Terminal value: average of Gordon growth ($404.5B) and exit multiple ($285.4B), discounted to $255.8B (83% of total value)
- Less net debt $25.3B → equity value $284.7B → **$66.17 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **KO (subject)** | $357.1B | 26.1 | 23.8 | — | 10.6 | — | — |
| Pepsico, Inc. | $185.6B | 17.8 | 15.1 | 12.1 | 8.7 | 10.8% | 51.5% |
| Keurig Dr Pepper Inc. | $41.5B | 22.6 | 12.1 | 17.4 | 1.6 | 10.8% | 6.3% |
| Monster Beverage Corporation | $96.8B | 47.8 | 38.2 | 32.9 | 11.1 | 23.1% | 26.7% |
| Mondelez International, Inc. | $75.3B | 29.0 | 17.4 | 18.3 | 2.9 | 6.6% | 10.2% |
| Procter & Gamble Company (The) | $343.2B | 21.5 | 20.9 | 14.6 | 6.4 | 19.2% | 31.1% |
...
- **The call:** SELL. Our target is $69.44 against a current price of $83.00, an implied return of -16.3%. Street consensus stands at $86.85.
- **The evidence:** our independent lenses value the shares at $66.17, $66.15, and $77.08. The blended base case is $69.44.
- **Conviction:** high. The widest and narrowest lenses differ by 1.2x. Tighter agreement between independent methods means higher confidence in the target.
