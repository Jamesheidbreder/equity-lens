...
| Price | $82.94 |
| Target price | **$69.41** (base model $69.41) |
| Implied upside | -16.3% |
...
We rate KO **SELL** with a price target of **$69.41**, against a current price of $82.94 (-16.3% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $66.16; peer comparables values the shares at $66.07; own historical multiple values the shares at $77.08.
...
### Discounted cash flow — $66.16 per share
...
### Peer comparables — $66.07 per share

| Assumption | Value |
|---|---|
| Trailing | eps 3.18; peer median pe 22.56 |
| Forward | eps 3.48; peer median pe 17.35 |
...
- Terminal value: average of Gordon growth ($404.5B) and exit multiple ($285.2B), discounted to $255.7B (83% of total value)
- Less net debt $25.3B → equity value $284.6B → **$66.16 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **KO (subject)** | $356.8B | 26.1 | 23.8 | — | 10.6 | — | — |
| Pepsico, Inc. | $185.4B | 17.8 | 15.1 | 12.1 | 8.7 | 10.8% | 51.5% |
| Keurig Dr Pepper Inc. | $41.4B | 22.6 | 12.1 | 17.4 | 1.6 | 10.8% | 6.3% |
| Monster Beverage Corporation | $96.8B | 47.8 | 38.2 | 32.9 | 11.1 | 23.1% | 26.7% |
| Mondelez International, Inc. | $75.2B | 29.0 | 17.4 | 18.3 | 2.9 | 6.6% | 10.2% |
| Procter & Gamble Company (The) | $343.1B | 21.5 | 20.9 | 14.6 | 6.4 | 19.2% | 31.1% |
...
- **The call:** SELL. Our target is $69.41 against a current price of $82.94, an implied return of -16.3%. Street consensus stands at $86.85.
- **The evidence:** our independent lenses value the shares at $66.16, $66.07, and $77.08. The blended base case is $69.41.
