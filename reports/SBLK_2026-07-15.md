...
| Price | $26.16 |
| Target price | **$36.69** (base model $36.69) |
| Implied upside | +40.3% |
...
We rate SBLK **BUY** with a price target of **$36.69**, against a current price of $26.16 (+40.3% implied return). Within our coverage universe, the name ranks **Top Pick**.

The target blends independent valuation lenses: discounted cash flow values the shares at $51.10; peer comparables values the shares at $29.21; own historical multiple values the shares at $24.97.

Our target sits +18.4% vs. street consensus of $30.98. The divergence is our documented view, not an input: consensus never enters the models.
...
### Discounted cash flow — $51.10 per share
...
### Peer comparables — $29.21 per share

| Assumption | Value |
|---|---|
| Trailing | eps 1.25; peer median pe 14.38 |
| Forward | eps 3.59; peer median pe 11.27 |
...
- Less net debt $0.4B → equity value $5.7B → **$51.10 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **SBLK (subject)** | $2.9B | 20.9 | 7.3 | — | 1.2 | — | — |
| Genco Shipping & Trading Limite | $1.1B | 64.8 | 14.4 | 15.4 | 1.2 | 4.4% | 1.9% |
| Safe Bulkers, Inc | $0.7B | 15.5 | 14.8 | 8.0 | 0.9 | 18.7% | 6.4% |
