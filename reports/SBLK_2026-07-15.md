...
We rate SBLK **BUY** with a price target of **$36.69**, against a current price of $26.18 (+40.1% implied return). Within our coverage universe, the name ranks **Top Pick**.

The target blends independent valuation lenses: discounted cash flow values the shares at $51.10; peer comparables values the shares at $29.20; own historical multiple values the shares at $24.97.
...
### Peer comparables — $29.20 per share

| Assumption | Value |
|---|---|
| Trailing | eps 1.25; peer median pe 14.36 |
