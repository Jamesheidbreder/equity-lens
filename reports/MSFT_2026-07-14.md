...
| Price | $384.93 |
| Target price | **$418.59** (base model $418.59) |
| Implied upside | +8.7% |
...
We rate MSFT **HOLD** with a price target of **$418.59**, against a current price of $384.93 (+8.7% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $217.43; peer comparables values the shares at $468.44; own historical multiple values the shares at $636.96.
...
### Discounted cash flow — $217.43 per share
...
### Peer comparables — $468.44 per share

| Assumption | Value |
|---|---|
| Trailing | eps 16.77; peer median pe 27.42 |
| Forward | eps 19.36; peer median pe 24.64 |
...
- Terminal value: average of Gordon growth ($1,337.1B) and exit multiple ($2,839.2B), discounted to $1,292.8B (80% of total value)
- Less net debt $9.9B → equity value $1,615.2B → **$217.43 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **MSFT (subject)** | $2,859.4B | 23.0 | 19.9 | — | 6.9 | — | — |
| Apple Inc. | $4,624.5B | 38.4 | 32.8 | 29.0 | 43.4 | 27.2% | 141.5% |
| Alphabet Inc. | $4,386.9B | 27.4 | 24.6 | 26.8 | 9.1 | 37.9% | 38.9% |
| Oracle Corporation | $368.5B | 21.9 | 11.7 | 16.7 | 9.8 | 25.4% | 53.4% |
| Salesforce, Inc. | $137.2B | 19.8 | 10.8 | 13.0 | 4.0 | 18.7% | 16.9% |
| Amazon.com, Inc. | $2,662.3B | 29.6 | 25.0 | 17.7 | 6.0 | 12.2% | 24.3% |
