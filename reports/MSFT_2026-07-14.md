...
| Price | $387.20 |
| Target price | **$418.28** (base model $418.28) |
| Implied upside | +8.0% |
...
- trailing: eps 16.77; peer median pe 27.31
- forward: eps 19.36; peer median pe 24.54
...
- Terminal value: average of Gordon growth ($1,346.0B) and exit multiple ($2,834.3B), discounted to $1,296.9B (80% of total value)
- Less net debt $9.9B → equity value $1,619.8B → **$218.05 per share**
