...
We rate MSFT **HOLD** with a price target of **$418.53**, against a current price of $384.93 (+8.7% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: discounted cash flow values the shares at $217.27; peer comparables values the shares at $468.44; own historical multiple values the shares at $636.96.
...
Cost of equity: **10.07%** (10Y Treasury 4.62% risk-free base, CAPM).
...
The base free cash flow of $65.1B is measured as operating cash flow less all capital expenditure (standard basis). Growth fades from 15.0% toward 2.5%, and each year is discounted at 10.07%.

| Year | Growth | Free cash flow | Discount factor | Present value |
|---|---|---|---|---|
| 1 | +15.0% | $74.9B | 0.908 | $68.1B |
| 2 | +11.9% | $83.8B | 0.825 | $69.2B |
| 3 | +8.8% | $91.2B | 0.750 | $68.3B |
| 4 | +5.6% | $96.3B | 0.681 | $65.6B |
| 5 | +2.5% | $98.7B | 0.619 | $61.1B |

- Sum of explicit-period value: $332.2B
- Terminal value: average of Gordon growth ($1,335.4B) and exit multiple ($2,839.2B), discounted to $1,291.6B (80% of total value)
- Less net debt $9.9B → equity value $1,614.0B → **$217.27 per share**
...
| Salesforce, Inc. | $137.2B | 19.4 | 10.8 | 13.3 | 4.0 | 18.7% | 16.9% |
