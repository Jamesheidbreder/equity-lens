...
| Price | $386.80 |
| Target price | **$418.06** (base model $418.06) |
| Implied upside | +8.1% |
...
We rate MSFT **HOLD** with a price target of **$418.06**, against a current price of $386.80 (+8.1% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: discounted cash flow values the shares at $218.00; peer comparables values the shares at $465.92; own historical multiple values the shares at $636.96.
...
**Peer comparables: $465.92**

- trailing: eps 16.77; peer median pe 27.27
- forward: eps 19.36; peer median pe 24.51
...
|---|---|---|---|---|---|
| 13.0% | 421 | 418 | 414 | 411 | 409 |
| 14.0% | 423 | 420 | 416 | 413 | 410 |
| 15.0% | 425 | 422 | 418 | 415 | 412 |
| 16.0% | 427 | 424 | 420 | 417 | 414 |
...
- Terminal value: average of Gordon growth ($1,346.0B) and exit multiple ($2,832.7B), discounted to $1,296.4B (80% of total value)
- Less net debt $9.9B → equity value $1,619.3B → **$218.00 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **MSFT (subject)** | $2,873.1B | 23.1 | 20.0 | — | 6.9 | — | — |
| Apple Inc. | $4,628.2B | 38.2 | 32.8 | 29.2 | 43.4 | 27.2% | 141.5% |
| Alphabet Inc. | $4,363.3B | 27.3 | 24.5 | 26.3 | 9.0 | 37.9% | 38.9% |
| Oracle Corporation | $373.7B | 22.3 | 11.9 | 17.1 | 9.9 | 25.4% | 53.4% |
| Salesforce, Inc. | $139.0B | 19.7 | 10.9 | 13.3 | 4.1 | 18.7% | 16.9% |
| Amazon.com, Inc. | $2,657.9B | 29.6 | 25.0 | 17.7 | 6.0 | 12.2% | 24.3% |
