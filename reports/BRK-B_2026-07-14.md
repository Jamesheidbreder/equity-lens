...
| Price | $493.99 |
| Target price | **$602.13** (base model $602.13) |
| Implied upside | +21.9% |
...
We rate BRK-B **BUY** with a target of **$602.13** vs. a current price of $493.99 (+21.9% implied). Within our coverage universe the name ranks **Top Pick**.

The target blends independent valuation lenses: justified pb $595.23, peer pb $609.04.
...
|---|---|---|---|---|---|---|---|
| **BRK-B (subject)** | $1,065.5B | 14.7 | 23.0 | — | 0.0 | — | — |
...
| Markel Group Inc. | $24.4B | 14.0 | 16.6 | 8.0 | 1.4 | 11.1% | 10.0% |
