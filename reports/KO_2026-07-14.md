...
| Price | $83.08 |
| Target price | **$69.33** (base model $69.33) |
| Implied upside | -16.5% |
...
We rate KO **SELL** with a price target of **$69.33**, against a current price of $83.08 (-16.5% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $66.07; peer comparables values the shares at $65.95; own historical multiple values the shares at $77.07.

Our target sits -20.2% vs. street consensus of $86.85. The divergence is our documented view, not an input: consensus never enters the models.
...
Cost of equity: **6.17%** (10Y Treasury 4.62% risk-free base, CAPM).
...
The base free cash flow of $9.5B is measured as operating cash flow less all capital expenditure (standard basis). Growth fades from 15.0% toward 2.5%, and each year is discounted at 6.17%.
...
| 5 | +2.5% | $14.4B | 0.741 | $10.7B |

- Sum of explicit-period value: $54.1B
- Terminal value: average of Gordon growth ($403.4B) and exit multiple ($285.7B), discounted to $255.4B (83% of total value)
- Less net debt $25.3B → equity value $284.3B → **$66.07 per share**
...
| Monster Beverage Corporation | $95.8B | 47.3 | 37.9 | 32.6 | 11.0 | 23.1% | 26.7% |
| Mondelez International, Inc. | $75.5B | 29.1 | 17.4 | 18.6 | 2.9 | 6.6% | 10.2% |
