...
| Price | $489.89 |
| Target price | **$592.47** (base model $592.47) |
| Implied upside | +20.9% |
...
We rate BRK-B **BUY** with a price target of **$592.47**, against a current price of $489.89 (+20.9% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: justified price-to-book values the shares at $589.17; peer price-to-book values the shares at $595.77.

Our target sits +13.9% vs. street consensus of $520.33. The divergence is our documented view, not an input: consensus never enters the models.
...
### Justified price-to-book — $589.17 per share

| Assumption | Value |
|---|---|
| Book per share | 332.51 |
| Normalized roe | 11.27% |
| Cost of equity | 7.45% |
| Growth | 2.50% |
| Fair pb multiple | 1.77 |

### Peer price-to-book — $595.77 per share
...
|---|---|---|---|---|---|
| 9.3% | 583 | 551 | 525 | 504 | 487 |
| 10.3% | 625 | 588 | 559 | 535 | 515 |
| 11.3% | 667 | 626 | 592 | 565 | 543 |
| 12.3% | 709 | 663 | 626 | 596 | 571 |
| 13.3% | 751 | 700 | 660 | 626 | 599 |

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **BRK-B (subject)** | $1,057.0B | 14.6 | 22.8 | — | 0.0 | — | — |
| Progressive Corporation (The) | $122.4B | 10.7 | 12.8 | 9.1 | 3.8 | 12.9% | 37.9% |
| Chubb Limited | $132.0B | 12.0 | 11.6 | 10.9 | 1.8 | 18.5% | 15.4% |
| Allstate Corporation (The) | $61.9B | 5.3 | 9.1 | 4.6 | 2.1 | 17.8% | 45.2% |
| Markel Group Inc. | $24.2B | 14.0 | 16.6 | 7.9 | 1.3 | 11.1% | 10.0% |
| Loews Corporation | $23.2B | 14.4 | 39.0 | 8.4 | 1.2 | 8.8% | 9.2% |
...
- **The call:** BUY with a $592.47 target against a $489.89 price (+20.9% implied); street consensus $520.33.
- **The evidence:** our independent lenses value the shares at $589.17 / $595.77; the blended base case is $592.47.
- **Conviction:** high — the widest and narrowest lenses differ by 1.0x; per our methodology, tighter agreement means higher confidence in the target.
