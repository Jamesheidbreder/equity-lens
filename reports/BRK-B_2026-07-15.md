...
| Price | $490.90 |
| Target price | **$592.26** (base model $592.26) |
| Implied upside | +20.6% |
...
We rate BRK-B **BUY** with a price target of **$592.26**, against a current price of $490.90 (+20.6% implied return). Within our coverage universe, the name ranks **Overweight**.

The target blends independent valuation lenses: justified price-to-book values the shares at $589.37; peer price-to-book values the shares at $595.15.

Our target sits +13.8% vs. street consensus of $520.33. The divergence is our documented view, not an input: consensus never enters the models.
...
### Peer price-to-book — $595.15 per share
