...
| Price | $314.86 |
| Target price | **$227.81** (base model $198.09) |
| Implied upside | -27.6% |
...
We rate AAPL **SELL** with a price target of **$227.81**, against a current price of $314.86 (-27.6% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $152.53; peer comparables values the shares at $190.20; own historical multiple values the shares at $266.74.
...
Our target sits -28.1% vs. street consensus of $316.76. The divergence is our documented view, not an input: consensus never enters the models.
...
### Peer comparables — $190.20 per share
...
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,624.5B | 38.2 | 32.8 | — | 43.4 | — | — |
