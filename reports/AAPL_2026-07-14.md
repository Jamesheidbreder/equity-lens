...
| Price | $315.18 |
| Target price | **$228.48** (base model $198.68) |
| Implied upside | -27.5% |
...
We rate AAPL **SELL** with a price target of **$228.48**, against a current price of $315.18 (-27.5% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $153.31; peer comparables values the shares at $191.10; own historical multiple values the shares at $266.74.
...
**Peer comparables: $191.10**

- trailing: eps 8.25; peer median pe 23.06
- forward: eps 9.61; peer median pe 19.98
...
- Terminal value: average of Gordon growth ($2,103.7B) and exit multiple ($3,600.9B), discounted to $1,783.2B (78% of total value)
- Less net debt $42.4B → equity value $2,251.7B → **$153.31 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,629.1B | 38.2 | 32.8 | — | 43.4 | — | — |
| Microsoft Corporation | $2,873.1B | 23.1 | 20.0 | 16.0 | 6.9 | 39.3% | 34.0% |
| Alphabet Inc. | $4,363.8B | 27.3 | 24.5 | 26.3 | 9.1 | 37.9% | 38.9% |
| Dell Technologies Inc. | $293.8B | 36.2 | 21.2 | 21.1 | -210.2 | 6.3% | — |
| HP Inc. | $22.5B | 8.9 | 8.2 | 6.3 | -156.9 | 4.4% | — |
