...
| Price | $314.77 |
| Target price | **$228.53** (base model $198.72) |
| Implied upside | -27.4% |
...
We rate AAPL **SELL** with a target of **$228.53** vs. a current price of $314.77 (-27.4% implied). Within our coverage universe the name ranks **Least Preferred**.

The target blends independent valuation lenses: dcf $153.33, comps $191.22, own multiple $266.74.
...
Our target sits -27.9% vs. street consensus of $316.76. The divergence is our documented view, not an input: consensus never enters the models.
...
- trailing: eps 8.25; peer median pe 23.08
- forward: eps 9.61; peer median pe 19.99
...
Base free cash flow $99.6B (ocf minus all capex (standard)); growth fades from 15.0% toward 2.5%; discounted at 9.85%.
...
- Terminal value: average of Gordon growth ($2,103.7B) and exit multiple ($3,601.8B), discounted to $1,783.4B (78% of total value)
- Less net debt $42.4B → equity value $2,252.0B → **$153.33 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,623.1B | 38.2 | 32.8 | — | 43.4 | — | — |
| Microsoft Corporation | $2,874.8B | 23.1 | 20.0 | 16.0 | 6.9 | 39.3% | 34.0% |
| Alphabet Inc. | $4,369.9B | 27.3 | 24.5 | 26.3 | 9.1 | 37.9% | 38.9% |
| Dell Technologies Inc. | $296.1B | 36.5 | 21.3 | 21.1 | -211.8 | 6.3% | — |
| HP Inc. | $22.9B | 9.1 | 8.3 | 6.3 | -159.2 | 4.4% | — |
| Sony Group Corporation | $122.7B | 19.9 | 17.6 | 0.0 | 2.5 | -2.6% | 12.3% |
