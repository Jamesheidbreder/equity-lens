...
| Price | $314.75 |
| Target price | **$228.57** (base model $198.76) |
| Implied upside | -27.4% |
...
We rate AAPL **SELL** with a target of **$228.57** vs. a current price of $314.75 (-27.4% implied). Within our coverage universe the name ranks **Least Preferred**.

The target blends independent valuation lenses: dcf $153.34, comps $191.32, own multiple $266.74.
...
- Terminal value: average of Gordon growth ($2,103.7B) and exit multiple ($3,602.6B), discounted to $1,783.7B (78% of total value)
- Less net debt $42.4B → equity value $2,252.2B → **$153.34 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **AAPL (subject)** | $4,622.8B | 38.2 | 32.8 | — | 43.4 | — | — |
| Microsoft Corporation | $2,876.4B | 23.1 | 20.0 | 16.0 | 6.9 | 39.3% | 34.0% |
| Alphabet Inc. | $4,376.4B | 27.4 | 24.6 | 26.3 | 9.1 | 37.9% | 38.9% |
| Dell Technologies Inc. | $296.6B | 36.6 | 21.4 | 21.1 | -212.2 | 6.3% | — |
| HP Inc. | $22.7B | 9.0 | 8.3 | 6.3 | -158.4 | 4.4% | — |
