...
| Price | $314.86 |
| Target price | **$227.57** (base model $197.89) |
| Implied upside | -27.7% |
...
We rate AAPL **SELL** with a price target of **$227.57**, against a current price of $314.86 (-27.7% implied return). Within our coverage universe, the name ranks **Least Preferred**.

The target blends independent valuation lenses: discounted cash flow values the shares at $152.53; peer comparables values the shares at $189.51; own historical multiple values the shares at $266.74.
...
Our target sits -28.2% vs. street consensus of $316.76. The divergence is our documented view, not an input: consensus never enters the models.
...
### Peer comparables — $189.51 per share

| Assumption | Value |
|---|---|
| Trailing | eps 8.19; peer median pe 22.95 |
| Forward | eps 9.61; peer median pe 19.88 |
| Peers used | MSFT, GOOGL, DELL, HPQ, SONY |

### Own historical multiple — $266.74 per share
...
|---|---|---|---|---|---|
| 13.0% | 201 | 198 | 195 | 193 | 191 |
| 14.0% | 202 | 199 | 197 | 194 | 192 |
| 15.0% | 203 | 201 | 198 | 196 | 193 |
| 16.0% | 205 | 202 | 199 | 197 | 195 |
| 17.0% | 206 | 203 | 201 | 198 | 196 |
