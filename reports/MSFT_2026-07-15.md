...
| Price | $397.12 |
| Target price | **$424.03** (base model $424.03) |
| Implied upside | +6.8% |
...
We rate MSFT **HOLD** with a price target of **$424.03**, against a current price of $397.12 (+6.8% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $219.15; peer comparables values the shares at $484.28; own historical multiple values the shares at $636.96.
...
### Discounted cash flow — $219.15 per share
...
### Peer comparables — $484.28 per share

| Assumption | Value |
|---|---|
| Trailing | eps 16.78; peer median pe 28.33 |
| Forward | eps 19.36; peer median pe 25.47 |
...
| 16.0% | 433 | 429 | 426 | 423 | 420 |
| 17.0% | 436 | 431 | 428 | 425 | 422 |
...
- Terminal value: average of Gordon growth ($1,337.1B) and exit multiple ($2,880.4B), discounted to $1,305.5B (80% of total value)
- Less net debt $9.9B → equity value $1,627.9B → **$219.15 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **MSFT (subject)** | $2,949.9B | 23.7 | 20.5 | — | 7.1 | — | — |
| Apple Inc. | $4,786.8B | 39.5 | 33.9 | 29.0 | 44.9 | 27.2% | 141.5% |
| Alphabet Inc. | $4,535.6B | 28.3 | 25.5 | 26.8 | 9.4 | 37.9% | 38.9% |
| Oracle Corporation | $379.9B | 22.6 | 12.1 | 16.7 | 10.1 | 25.4% | 53.4% |
| Salesforce, Inc. | $138.4B | 19.6 | 10.9 | 13.0 | 4.0 | 18.7% | 16.9% |
| Amazon.com, Inc. | $2,742.1B | 30.5 | 25.8 | 17.7 | 6.2 | 12.2% | 24.3% |
...
- **The call:** HOLD with a $424.03 target against a $397.12 price (+6.8% implied); street consensus $559.86.
- **The evidence:** our independent lenses value the shares at $219.15 / $484.28 / $636.96; the blended base case is $424.03.
- **Conviction:** low — the widest and narrowest lenses differ by 2.9x; per our methodology, tighter agreement means higher confidence in the target.
- **Within coverage:** ranked Neutral (#4) among the names we cover.
- **Standing review:** the rating is re-examined at every quarterly print against the triggers listed under Catalysts; calls and targets are logged, dated, and never rewritten.
