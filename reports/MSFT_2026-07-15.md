...
| Price | $397.64 |
| Target price | **$423.67** (base model $423.67) |
| Implied upside | +6.5% |
...
We rate MSFT **HOLD** with a price target of **$423.67**, against a current price of $397.64 (+6.5% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $219.08; peer comparables values the shares at $483.17; own historical multiple values the shares at $636.96.
...
### Discounted cash flow — $219.08 per share
...
### Peer comparables — $483.17 per share

| Assumption | Value |
|---|---|
| Trailing | eps 16.78; peer median pe 28.27 |
| Forward | eps 19.36; peer median pe 25.42 |
...
- Terminal value: average of Gordon growth ($1,337.1B) and exit multiple ($2,877.5B), discounted to $1,304.6B (80% of total value)
- Less net debt $9.9B → equity value $1,627.0B → **$219.08 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **MSFT (subject)** | $2,953.2B | 23.7 | 20.5 | — | 7.1 | — | — |
| Apple Inc. | $4,776.5B | 39.4 | 33.8 | 29.0 | 44.8 | 27.2% | 141.5% |
| Alphabet Inc. | $4,525.2B | 28.3 | 25.4 | 26.8 | 9.4 | 37.9% | 38.9% |
| Oracle Corporation | $379.4B | 22.6 | 12.1 | 16.7 | 10.1 | 25.4% | 53.4% |
| Salesforce, Inc. | $138.9B | 19.6 | 10.9 | 13.0 | 4.1 | 18.7% | 16.9% |
| Amazon.com, Inc. | $2,754.6B | 30.6 | 25.9 | 17.7 | 6.2 | 12.2% | 24.3% |
