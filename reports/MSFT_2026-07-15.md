...
| Price | $397.22 |
| Target price | **$423.61** (base model $423.61) |
| Implied upside | +6.6% |
...
We rate MSFT **HOLD** with a price target of **$423.61**, against a current price of $397.22 (+6.6% implied return). Within our coverage universe, the name ranks **Neutral**.

The target blends independent valuation lenses: discounted cash flow values the shares at $219.02; peer comparables values the shares at $483.05; own historical multiple values the shares at $636.96.
...
### Discounted cash flow — $219.02 per share
...
### Peer comparables — $483.05 per share

| Assumption | Value |
|---|---|
| Trailing | eps 16.78; peer median pe 28.26 |
| Forward | eps 19.36; peer median pe 25.41 |
...
|---|---|---|---|---|---|
| 13.0% | 427 | 423 | 420 | 417 | 414 |
| 14.0% | 429 | 425 | 422 | 419 | 416 |
| 15.0% | 431 | 427 | 424 | 420 | 418 |
| 16.0% | 433 | 429 | 426 | 422 | 419 |
| 17.0% | 435 | 431 | 427 | 424 | 421 |
...
- Terminal value: average of Gordon growth ($1,337.1B) and exit multiple ($2,877.2B), discounted to $1,304.5B (80% of total value)
- Less net debt $9.9B → equity value $1,626.9B → **$219.02 per share**

### Comparable companies

| Company | Mkt cap | P/E (ttm) | P/E (fwd) | EV/EBITDA | P/B | Net margin | ROE |
|---|---|---|---|---|---|---|---|
| **MSFT (subject)** | $2,950.7B | 23.7 | 20.5 | — | 7.1 | — | — |
| Apple Inc. | $4,787.9B | 39.5 | 33.9 | 29.0 | 44.9 | 27.2% | 141.5% |
| Alphabet Inc. | $4,524.1B | 28.3 | 25.4 | 26.8 | 9.4 | 37.9% | 38.9% |
| Oracle Corporation | $379.6B | 22.6 | 12.1 | 16.7 | 10.1 | 25.4% | 53.4% |
| Salesforce, Inc. | $138.6B | 19.6 | 10.9 | 13.0 | 4.0 | 18.7% | 16.9% |
| Amazon.com, Inc. | $2,740.9B | 30.4 | 25.8 | 17.7 | 6.2 | 12.2% | 24.3% |
